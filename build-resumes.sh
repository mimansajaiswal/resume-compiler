...
typst compile --input "last_updated=${LAST_UPDATED}" --input "mode=default" resume.typ "$OUT_DIR/$OUT_MAIN"
typst compile --input "last_updated=${LAST_UPDATED}" --input "mode=short" resume.typ "$OUT_DIR/$OUT_S"
typst compile --input "last_updated=${LAST_UPDATED}" --input "mode=bibtex" resume.typ "$OUT_DIR/$OUT_B"
typst compile --input "last_updated=${LAST_UPDATED}" --input "mode=no-js" resume.typ "$OUT_DIR/$OUT_N"
