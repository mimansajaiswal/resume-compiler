...
OUT_L="${NAME_STEM}_Resume_L.pdf"
OUT_S="${NAME_STEM}_Resume_S.pdf"
OUT_C="${NAME_STEM}_Resume_C.pdf"
OUT_B="${NAME_STEM}_Resume_B.pdf"
OUT_N="${NAME_STEM}_Resume_N.pdf"

typst compile --input "last_updated=${LAST_UPDATED}" resume.typ "$OUT_L"
typst compile --input "last_updated=${LAST_UPDATED}" resume-short.typ "$OUT_S"
typst compile --input "last_updated=${LAST_UPDATED}" resume-with-config.typ "$OUT_C"
typst compile --input "last_updated=${LAST_UPDATED}" resume-with-bibtex.typ "$OUT_B"
typst compile --input "last_updated=${LAST_UPDATED}" resume-no-js.typ "$OUT_N"
